...
file_to_load = os.path.join(r'/Users/bigd/Downloads/Analysis/election_results.csv')
file_to_save = os.path.join(r'/Users/bigd/Downloads/Analysis/election_analysis.txt')
